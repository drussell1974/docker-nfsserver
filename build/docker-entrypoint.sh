...
echo "docker-entrypoint.sh: Getting contents of subdirectory /mnt/nfs_share/${NFS_HOME_PATH} ..."
ls -l /mnt/nfs_share/${NFS_HOME_PATH}

echo "docker-entrypoint.sh: Getting contents of subdirectory /mnt/nfs_share/${NFS_PULIC_PATH} ..."
ls -l /mnt/nfs_share/${NFS_PUBLIC_PATH}
